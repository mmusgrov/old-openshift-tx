...
oc new-app jboss-eap-64~https://github.com/mmusgrov/openshift-cases.git#eap64 --context-dir='jboss-eap-remote-ejb/greeter-client' --name='greeter-client' --labels name='greeter-client'
