...
oc new-app jboss-eap-64~https://github.com/mmusgrov/openshift-cases.git#eap64 --context-dir='jboss-eap-remote-ejb/greeter-server' --name='greeter-server' --labels name='greeter-server'
